...
cssLink.setAttribute('href', 'static/css/style00.css')
...
document.addEventListener("DOMContentLoaded", event => {
	...
	window.addEventListener("resize", (e) => {
		document.getElementsByTagName('main')[0].setAttribute('style', `margin-top:${header.offsetHeight}px;`)
	})
	links.forEach((link, i) => {
		link.setAttribute('data-source', `static/css/style${paddedNum(i)}.css`)
